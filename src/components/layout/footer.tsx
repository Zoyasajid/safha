    ...
    <footer className="mt-auto border-t border-line bg-ink text-cream">
      <Container className="grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="mt-4 max-w-xs text-sm leading-relaxed text-cream/70">
            A curated bookshop for Karachi — authentic editions, considered
            taste, and delivery that respects your time.
          </p>
        </div>
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-cream/80">
            ...
            <li>
              <Link href="/authors" className="hover:text-gold">
                Authors
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/urdu" className="hover:text-gold">
                Urdu Books
              </Link>
            </li>
            <li>
              <Link href="/english" className="hover:text-gold">
                English Books
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <p className="mt-4 text-xs uppercase tracking-[0.16em] text-cream/50">
            We accept
          </p>
          ...
          <div className="mt-4 flex gap-3 text-sm">
            ...
            <a
              href="https://www.facebook.com/profile.php?id=61594633775331"
              target="blank"
      ...
      <div className="border-t border-white/10">
        <Container className="flex flex-col gap-2 py-5 text-xs text-cream/50 sm:flex-row sm:justify-between">
          <p>
            © {new Date().getFullYear()} Safha Bookshop, Karachi. All rights
            reserved.
          </p>
